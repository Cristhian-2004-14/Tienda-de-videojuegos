...
<template>
  <AdminLayout titulo="Clientes" buscador-placeholder="Buscar clientes...">
    <template #header><div class="header"><div><h2>Clientes</h2><p>Administra y consulta tu base de clientes.</p></div><router-link class="btn-primary" to="/admin/clientes/nuevo"><span class="material-symbols-outlined">person_add</span>Agregar cliente</router-link></div></template>
